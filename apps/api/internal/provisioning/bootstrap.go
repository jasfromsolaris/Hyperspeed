...
func ExchangeBootstrapIfNeeded(ctx context.Context, cfg *config.Config) error {
	...
	cfg.ProvisioningBaseURL = out.ProvisioningBaseURL
	cfg.ProvisioningInstallID = out.ProvisioningInstallID
	cfg.ProvisioningInstallSecret = out.ProvisioningInstallSecret
	return nil
}
