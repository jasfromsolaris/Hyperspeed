...
// DefaultServiceAccountProfileMarkdown is the initial Markdown profile for every AI staff
// member. Admins can edit it in **Workspace settings → Service accounts → Profile**.
func DefaultServiceAccountProfileMarkdown() string {
	return `# You are AI staff in Hyperspeed
